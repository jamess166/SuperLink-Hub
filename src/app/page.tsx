        ...
        <div className="container mx-auto px-4 py-6 sm:px-6 lg:px-8">
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              <LinkCard title="Entorno Común de Datos" links={bim360CommonDataLinks} defaultButtonVariant="default" />
              <LinkCard title="Expedientes Aprobados por Entregable" links={bim360DeliverablesLinks} defaultButtonVariant="accent" />
            </div>
          </section>
          ...
          <section className="mb-10">
            ...
            <div className="max-w-2xl"> {/* Constrain width for single column card list */}
              <LinkCard links={ceselEnvironmentLinks} defaultButtonVariant="dark" />
            </div>
          </section>
        </div>
      </main>
